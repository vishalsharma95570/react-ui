  ...
  <div className="container mt-4">
    <div className="row">
      <div className="col-md-12 tnc">
        <h4 className ="text-center">PLEASE READ THESE TERMS AND CONDITIONS CAREFULLY</h4>
        <h2>AGREEMENT TO TERMS</h2>
        <p>
          These Terms and Conditions constitute a legally binding agreement made
          between you, whether personally or on behalf of an entity (“you”) and
          Miracle Eye Pvt Ltd (“we,” “us” or “our”), concerning your access to
          and use of the [website mydiginetwork.com] website as well as any
        ...
        <p>
          ...
          “Last updated” date of these Terms and Conditions and you waive any
        ...
        <p>
          ...
          of the Inda, foreign jurisdictions, and international conventions. The
        ...
        <p>
          ...
          rights not expressly granted to you in and to the Site, Content and
          the Marks.
        </p>
        ...
        <p>
          <ol>
            ...
            <li>
              {" "}
              The data stored on this site will be used for training and
        ...
        <p>
          ...
          is subject to a Indian government embargo, or that has been designated
          by the Indian government as a “terrorist supporting” country and (ii)
          you are not listed on any Indian government list of prohibited or
        ...
        <p>
          ...
          in accordance with the Indian Children’s Online Privacy Protection
        ...
        <p>
          ...
          first contacting an attorney. All Notifications should meet the
          ...
          the Site are covered by the Notification, a representative list of
          such works on the Site; (3) identification of the material that is
        ...
        <p>
          Designated Copyright Agent<br></br>
          R. N. Gupta <br></br>
          Attn: Copyright Agent<br></br>
          545 Sector 15 Part I <br></br>
          Gurgaon India<br></br>
          rngupta@mydiginetwork.com
        </p>
        ...
        <p>
          ...
          Gurgaon India, and the Parties hereby consent to, and waive all
        ...
        <h4>Option 2: Informal Negotiations</h4>
        <p>
        ...
        <h4>Option 2/Option 3: Restrictions</h4>
        <p>
        ...
        <p>
          ...
          EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST
           ...
           [THE LESSER OF] [THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE 2 
           MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING [OR] 1000Rs. CERTAIN 
        ...
        <p>
          Miracle Eye Pvt Ltd <br></br>
          545 Sector 15 Part I Gurgaon <br></br>
          8527893222 <br></br>
          rngupta@mydiginetwork.com <br></br>
        </p>
      </div>
    </div>
  </div>
